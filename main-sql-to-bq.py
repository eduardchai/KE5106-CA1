...
if __name__ == "__main__":
    ...
    fact_employment.main(server, database, username, password, driver, bigquery_dataset, "fact_employment")
    fact_happiness.main(server, database, username, password, driver, bigquery_dataset, "fact_happiness")
    fact_living_cost.main(server, database, username, password, driver, bigquery_dataset, "fact_living_cost")
    fact_marital_status.main(server, database, username, password, driver, bigquery_dataset, "fact_marital_status")