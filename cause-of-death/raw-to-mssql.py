...
(year, country, population, all_causes, nutritional_conditions, infectious_diseases, respiratory_infectious, maternal_conditions, neonatal_conditions, nutritional_deficiencies, noncommunicable_diseases, malignant_neoplasms, other_neoplasms, diabetes_mellitus, endocrine_blood_immune_disorders, mental_substance_use_disorders, neurological_conditions, sense_organ_diseases, cardiovascular_diseases, respiratory_diseases, digestive_diseases, genitourinary_diseases, skin_diseases, musculoskeletal_diseases, congenital_anomalies, oral_conditions, sudden_infant_death_syndrome, injuries, unintentional_injuries, intentional_injuries)
VALUES 
(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)"""
